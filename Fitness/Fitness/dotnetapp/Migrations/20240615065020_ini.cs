        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageWorkoutDurationInMinutes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkoutRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    WorkoutId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutRequests", x => x.WorkoutRequestId);
                    table.ForeignKey(
                        name: "FK_WorkoutRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutRequests_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutRequests_UserId",
                table: "WorkoutRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutRequests_WorkoutId",
                table: "WorkoutRequests",
                column: "WorkoutId");
        }
